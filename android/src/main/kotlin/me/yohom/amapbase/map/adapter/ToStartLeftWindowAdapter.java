 ...
 * 司机剩余时长、距离infoWindow
 */
public class ToStartLeftWindowAdapter implements AMap.InfoWindowAdapter {

    private Context context;
//    private Setting setting;

    public ToStartLeftWindowAdapter(Context context) {
...
//        setting = Setting.findOne();
    ...
    public View getInfoContents(Marker marker) {
        String leftDis = marker.getSnippet();//剩余距离
